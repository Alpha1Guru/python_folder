...
for i in range(len(students_data)):
    ...
    order = check_sorted_name_hall_index(studentsname=students_data[i]["name"],hallname=hall)    

    students_by_hall_name_and_class[hall].insert(order,[students_data[i]["name"],students_data[i]["class"]])
